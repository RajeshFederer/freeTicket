...
let persistIntents = () => {
    ...
    .matches('bookTicket', [(session, args,callback) =>{
        ...
        let destinationLocation = builder.EntityRecognizer.findEntity(intent.entities, 'destinationLocation');
        let originLocation = builder.EntityRecognizer.findEntity(intent.entities, 'originLocation');
