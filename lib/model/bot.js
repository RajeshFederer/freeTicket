...
let persistIntents = () => {
    ...
    .matches('bookTicket', [(session, args,callback) =>{
        ...
        let noOfTickets = builder.EntityRecognizer.findEntity(intent.entities, 'builtin.number');
        let destinationLocation = builder.EntityRecognizer.findEntity(intent.entities, 'location::destinationLocation');
        let originLocation = builder.EntityRecognizer.findEntity(intent.entities, 'location::originLocation');
        let travelClass = builder.EntityRecognizer.findEntity(intent.entities, 'travelClass');
        console.log(intent.entities+'DATE '+ dateOfTravel + ' noOfTickets :'+ noOfTickets + 'DESTINATION '+destinationLocation + 'ORIGIN '+ originLocation + 'TRAVEL CLASS '+ travelClass);
        console.log('DLOC '+ builder.EntityRecognizer.findEntity(intent.entities, 'location.destinationLocation'));
        console.log('DLOC 2 '+builder.EntityRecognizer.findEntity(intent.entities, 'destinationLocation'));
        console.log('DLOC 3 '+builder.EntityRecognizer.findEntity(intent.entities, 'location'));
        session.userData = {};
        if (noOfTickets) {
